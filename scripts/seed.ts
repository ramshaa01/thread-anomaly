...
const PRODUCTS = [
  {
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    colors: ['White'],
    images: ['/images/products/hose-bee-lion.jpg', '/images/products/hose-bee-lion-2.jpg'],
    stock: 50,
    isNew: true,
    isBestSeller: true,
    rating: 4.8,
  ...
  },
  {
    ...
    sizes: ['L', 'XL', 'XXL'],
    colors: ['Black'],
    images: ['/images/products/physique-powered.jpg', '/images/products/physique-powered-2.jpg'],
    stock: 75,
    isNew: true,
    isBestSeller: false,
    rating: 5.0,
